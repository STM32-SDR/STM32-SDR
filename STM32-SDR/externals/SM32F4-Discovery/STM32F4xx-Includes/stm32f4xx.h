...
//#define FLASH_BASE            ((uint32_t)0x08008000) /*!< FLASH(up to 1 MB) base address in the alias region                         */
#define FLASH_BASE            ((uint32_t)BASE_ADDRESS) /*!< FLASH(up to 1 MB) base address in the alias region                         */
