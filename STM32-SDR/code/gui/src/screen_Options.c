...
void ScreenOptions_Create(void)
{
	...
	GL_PageControls_TypeDef* lblDirections3 = Widget_NewLabel("Changes applied instantly.", LCD_COLOR_WHITE, LCD_COLOR_BLACK, 0, GL_FONTOPTION_8x12Bold, 0);
	...
	AddPageControlObj(90, LCD_HEIGHT - 42, lblDirections3,  s_pThisScreen);
